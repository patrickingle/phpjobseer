...
// Don't say anything if either of these fields is not set properly.
if ( ( !isset($_GET['url']) )
  || ( ''===$_GET['url'] )
  || ( !isset($_GET['jobId']) )
  || ( ''===$_GET['jobId'] )
  || ( !preg_match('/^[1-9]([0-9]*)$/', $subject) )
   ) {
    exit();
}
...
$jobIdLimit = " and jobId <> '"
            . mysqli_real_escape_string($_GET['jobId'])
            . "'";

$oJob = new JobDao();
$queryString = "url = '" . mysqli_real_escape_string($url) . "' $jobIdLimit";
